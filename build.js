...
// - Conventions:
// * code is in a assets/js/lib/ folder with a main.js as the main context (closure)
...
concat({
	src: src,
	dest: 'assets/js/'+ name +'.js'
});


// - Validate js
lint('assets/js/'+ name +'.js', function(){

	// - Create / save minified file
	minify('assets/js/'+ name +'.js', 'assets/js/'+ name +'-min.js');
...
function concat(opts) {
	...
	var wrapper = fs.readFileSync('assets/js/lib/main.js', FILE_ENCODING);
